...
Условие отображения: После заполнения формы внесения данных выбрав способ оплаты карта
...
|----------|------------------------|----------|------------|
| Заполнение формы данных клиента | Ввод данных в форму | - | Валидация полей при вводе |
